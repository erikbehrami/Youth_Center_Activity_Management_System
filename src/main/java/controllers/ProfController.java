...
public class ProfController extends BaseController {
    ...
    @FXML
    private void handleProfProfile() {
        sceneManager.switchScene(Navigator.PROFILE, "Prof Profile");
    }

    @FXML
    private void handleProfMessages() {
        sceneManager.switchScene(Navigator.PROF_MESSAGES, "Prof Messages");
    }
